...
<pre class="text-xs md:text-sm overflow-x-auto"><code>[
  ...
  "status": {
    ...
    "block_time": 1771054926
            ...
            <x-api-section method="POST" path="/tx" :description="'Broadcasts a raw transaction to the network. The transaction hex should be provided in the request body.'" responseContentType="text/plain">
                <x-slot:example>
                    <code>curl -X POST --data &quot;01000000...&quot; {{ route('api.tx.broadcast') }}</code>
                </x-slot:example>
                <x-slot:response>
                    <code class="text-xs md:text-sm break-all">2c603d097588bb7d520ffb8b270cc61865f52c1427504ab43678fc055d07c261</code>
                </x-slot:response>
            </x-api-section>
